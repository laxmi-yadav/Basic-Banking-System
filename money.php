<?php
	session_start();
  $connect = mysqli_connect("localhost", "root", "", "DHANLAXMI");
?> 
<!DOCTYPE html>
<html>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<style type="text/css">
		...
		body{
			background-image: url("https://charlesdrew.com/wp-content/uploads/2015/11/Grey-Background.jpg");
			margin: 0;
	...
	<div class="container">
		<form action="transfer.php" method="post">
			...
			<datalist id="names">
				...
				<option value="Bhavana Moily"></option>
				<option value="Sreyas Sawant"></option>
				<option value="GR Yadav"></option>
				<option value="Rani Yadav"></option>
